...
public class Interfaz extends javax.swing.JFrame {
    ...
    public Interfaz(Temperatura temp, String nombre) {
        initComponents();
        temperatura = temp;
        ...
        setTitle("Registro de temperaturas en " + nombre);
        setVisible(true);
    }

    public Boolean comparaObjetoTemperatura(Temperatura temp){
        return this.temperatura.equals(temp);
    }
